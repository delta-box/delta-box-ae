# figure-01: Baseline phase costs

Phase data and the Table 2 cohorts are provided. Historical plotting used adjustments/fallback values that still require reconciliation.
