...
_CRIU_NETWORK_LOCK_METHOD = _descriptor.EnumDescriptor(
  name='criu_network_lock_method',
  full_name='criu_network_lock_method',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='IPTABLES', index=0, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='NFTABLES', index=1, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_CRIU_NETWORK_LOCK_METHOD)
...
_CRIU_OPTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pidfd_store_sk', full_name='criu_opts.pidfd_store_sk', index=60,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='lsm_mount_context', full_name='criu_opts.lsm_mount_context', index=61,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='network_lock', full_name='criu_opts.network_lock', index=62,
...
_CRIU_FEATURES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pidfd_store', full_name='criu_features.pidfd_store', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CRIU_OPTS.fields_by_name['network_lock'].enum_type = _CRIU_NETWORK_LOCK_METHOD
...
DESCRIPTOR.enum_types_by_name['criu_network_lock_method'] = _CRIU_NETWORK_LOCK_METHOD
